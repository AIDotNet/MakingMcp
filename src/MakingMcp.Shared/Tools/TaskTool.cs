...
public class TaskTool
{
    ...
    private static Kernel CreateKernelForAgent(Func<string, Task> completeTaskFunc)
    {
        ...
        AddToolsToKernel(kernelBuilder, AgentTools.All);
    ...
    private static void AddToolsToKernel(IKernelBuilder kernelBuilder, AgentTools tools)
    {
        ...
        if (tools.HasFlag(AgentTools.Web) && !string.IsNullOrEmpty(WebTool.GetTavilyApiKey()))
        {
            kernelBuilder.Plugins.AddFromType<WebTool>();
        }
    }
